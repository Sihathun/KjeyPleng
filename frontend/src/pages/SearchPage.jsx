                  ...
                  <div className="overflow-hidden transition-shadow bg-white border-2 border-gray-200 rounded-2xl hover:shadow-xl">
                    <div className="relative h-64 bg-gray-100">
                      ...
                      {product.is_featured && product.seller_is_premium && (
                        <span className="absolute top-2 left-2 inline-flex items-center gap-1 bg-yellow-400 text-yellow-900 text-xs font-medium px-2 py-1 rounded-full shadow-sm">
