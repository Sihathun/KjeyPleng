...
export default function Navbar() {
  ...
  return (
    <nav className="w-full border-b border-black/50">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-8 py-4 flex items-center gap-4 sm:gap-8">
        {/* Logo */}
        <Link to="/">
          <div className="flex items-center">
            <h1 className="bg-linear-to-r from-blue-500 to-black bg-clip-text text-transparent text-lg sm:text-xl">
              <span>kjey</span>
        ...
        <div className="lg:hidden fixed inset-0 top-[73px] bg-white z-50 overflow-y-auto">
          <div className="p-4 space-y-4">
            ...
            <div className="relative">
              <div className="absolute left-3 top-1/2 -translate-y-1/2 text-black/75">
                <Search className="w-5 h-5" />
              </div>
              <input
                type="text"
            ...
            <div className="space-y-1">
              <Link 
                ...
                className="block px-4 py-3 text-lg hover:bg-gray-100 rounded-xl transition-colors"
              >
                Home
              </Link>
              <Link 
              ...
              {isAuthenticated && user && (
                <>
                  ...
                  <Link 
                    to="/account-settings" 
                    onClick={() => setMobileMenuOpen(false)}
                    className="flex items-center gap-3 px-4 py-3 text-lg hover:bg-gray-100 rounded-xl transition-colors"
                  >
                  ...
                  <button
                    ...
                    className="w-full flex items-center gap-3 px-4 py-3 text-lg text-red-600 hover:bg-red-50 rounded-xl transition-colors"
                  >
              ...
              {!isAuthenticated && (
                ...
                >
                  <button className="w-full px-6 py-3 bg-blue-500 text-white rounded-full hover:bg-blue-600 transition-colors text-lg">
                    Login
                  </button>
                </Link>
              )}
